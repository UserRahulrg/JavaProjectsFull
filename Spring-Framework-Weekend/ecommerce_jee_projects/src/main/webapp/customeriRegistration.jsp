...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f9; padding: 50px; text-align: center;">
    ...
    <div style="max-width: 400px; margin: auto; padding: 30px; background-color: white; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        <h2 style="margin-bottom: 20px; color: #333;">Customer-Registration Form</h2>
        
        <form action="#" method="post">
            <div style="margin-bottom: 15px;">
                <label for="id   " style="display: block; font-size: 14px; color: #333;">Id   :</label>
                <input type="id   " id="id   " name="id   " required placeholder="Enter your id   " style="width: 100%; padding: 10px; font-size: 14px; border-radius: 4px; border: 1px solid #ccc;"/>
            </div>
        
            <div style="margin-bottom: 15px;">
                <label for="name " style="display: block; font-size: 14px; color: #333;">Name :</label>
                <input type="name " id="name " name="name " required placeholder="Enter your name " style="width: 100%; padding: 10px; font-size: 14px; border-radius: 4px; border: 1px solid #ccc;"/>
            </div>
